package no.nav.helsemelding.message.client.scopedhttpclient
...
import no.nav.helsemelding.message.client.scopedhttpclient.config.AzureAuth
import no.nav.helsemelding.message.client.scopedhttpclient.config.Config
